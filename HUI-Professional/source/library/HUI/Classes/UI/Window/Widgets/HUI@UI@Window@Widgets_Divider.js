...
__H.register(__H.UI.Window.Widgets,"Divider","Divider",function Divider(){
	...
	var initialize = function initialize(bForce){
		...
		__HLog.debug("Initializing class: __H.UI.Window.Widgets.Divider")
...
var __HDivider = new __H.UI.Window.Widgets.Divider()